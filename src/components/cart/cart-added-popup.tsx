...
/**
 * Full-screen "Added to Cart!" confirmation modal. Rendered into document.body
 * via a portal. Shared by the product-card Add-to-Cart button and the product
 * detail page so the confirmation looks identical everywhere.
 */
